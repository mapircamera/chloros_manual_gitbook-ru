...
Если вы выводите откалиброванные изображения в Chloros в виде типичного JPG или TIFF, то процент отражательной способности рассчитывается путем деления значения пикселя на битовую глубину формата изображения. Таким образом, для JPG делите на 255, а для TIFF делите на 65 535. Вы также можете выбрать вывод в формате PERCENT в Chloros, и тогда каждый пиксель будет иметь значение от 0,0 до 1,0 (0% до 100% отражательной способности). Просто имейте в виду, что некоторые приложения для работы с изображениями не могут принимать изображения в процентах (с плавающей запятой), а также что они занимают много места при хранении.
