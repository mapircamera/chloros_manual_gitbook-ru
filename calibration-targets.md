...
MAPIR предлагает различные калибровочные мишени для широкого спектра применений. Компактная модель T4-R50, представленная ниже, содержит 4 панели, которые были измерены на светоотражение в диапазоне от 250 до 2500 нм.
