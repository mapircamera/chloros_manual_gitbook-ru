...
Пакетная обработка командной строки. Идеально подходит для автоматизации, написания скриптов и сложных рабочих процессов. _Для доступа к CLI требуется лицензия Chloros+._

## [Chloros API: Python SDK](api-python-sdk.md)

Программный интерфейс Python для автоматизации и настройки рабочих процессов. Идеально подходит для исследовательских конвейеров, интеграции с существующими приложениями Python и создания пользовательских инструментов. _Для доступа к API требуется лицензия Chloros+._
...
* **Ускорение GPU (CUDA)**: используйте преимущества современных вариантов памяти GPU с более высокой емкостью для дальнейшего ускорения конвейера обработки изображений. Для достижения наилучших результатов мы рекомендуем 4 ГБ или более VRAM.
