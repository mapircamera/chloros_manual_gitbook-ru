...
| `backend_startup_timeout` | int  | `60`                      | Таймаут запуска бэкэндазапуска бэкэнда (секунды) |
...
**Возвращает:** `dict` — ответ о создании проекта.
...
| `export_format`           | str  | «TIFF (16-битный)»         | Формат вывода                   |
...
| `progress_callback`       | callable | `None`          | Обратная связь о ходе выполнения              |
...
4. **Обрабатывайте на SSD** (не на HDD)
...
**О:** Код SDK можно интегрировать в ваши приложения, но:
...
### В: Можно ли обрабатывать изображения из скриптов Python, запускаемых по расписанию?

**О:** Да! Используйте планировщик задач Windows со скриптами Python:
...
Запланируйте ежедневное выполнение с помощью планировщика задач.

***

### В: Поддерживает ли SDK async/await?
