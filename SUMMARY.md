...
* [GUI : Проекты](projects.md)
* [CLI: Командная строка](CLI.md)
* [API: Python SDK](api-python-sdk.md)
* [Поддерживаемые камеры](supported-cameras.md)
* [Форматы выходных изображений](output-image-formats.md)
...
* [Запуск обработки](processing-images-gui/starting-the-processing.md)
* [Мониторинг обработки](processing-images-gui/monitoring-the-processing.md)
* [Завершение обработки](processing-images-gui/finishing-the-processing.md)

## НАСТРОЙКИ ПРОЕКТА

* [Настройки проекта](project-settings/project-settings.md)
* [Формулы мультиспектральных индексов](project-settings/multispectral-index-formulas.md)
