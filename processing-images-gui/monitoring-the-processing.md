...
* Если процесс занимает слишком много времени, возможно, цели не отмечены
...
* **Калибровка отражения**: нормализация с помощью целевых значений
* **Расчет индекса**: вычисление мультиспектральных индексов
* Обработка каждого изображения по полной схеме
...
* Завершенные изображения / Всего изображений
...
| «Цели не найдены»               | Цели калибровки не обнаружены        | Пометьте изображения целей или отключите калибровку отражения |
| «Недостаточно места на диске»        | Недостаточно места для вывода          | Освободить место на диске                                    |
| «Пропуск поврежденного файла»        | Файл изображения поврежден                  | Перекопировать файл с SD-карты                             |
...
* Рассмотрите возможность уменьшения количества одновременных задач или модернизации оборудования
...
2. Переместите проект на диск с большим объемом памяти
3. Уменьшите количество индексов для экспорта.
4. Используйте формат JPG вместо TIFF (меньшие файлы).
